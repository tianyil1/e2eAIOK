...
python -m intel_extension_for_pytorch.cpu.launch --distributed --nproc_per_node=1 --nnodes=1 /home/vmagent/app/e2eAIOK/e2eAIOK/DeNas/train.py --domain bert --conf /home/vmagent/app/e2eAIOK/conf/denas/nlp/e2eaiok_denas_train_bert.conf #2>&1 | tee BERT_training_${RANDOM_SEED}.log
